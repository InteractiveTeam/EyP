...
function twentysixteen_industriales_shortcode( $atts ) {
    $args = array('post_type' => 'generadores_industri','post_status'=>'publish');
    $posts = new WP_Query($args);	
    
    $body = "<table class='".$atts['class']."'>
       <thead>
            <tr>
                <th>Nombre</th>
                <th>Referencia</th>
        ...
        while ($posts->have_posts()) : $posts->the_post();
            $dataPost = get_post_complete(get_the_ID());

            $body .="<tr>
                <td>".$dataPost['post_content']."</td>
                <td>".$dataPost['Referencia']."</td>
                <td>".$dataPost['marca']."</td>
                <td>".$dataPost['RPM']."</td>
                <td>
                    <a href='".wp_get_attachment_url($dataPost['pdf_indus'])."'>
                        PDF    
                    </a>
                </td>
            </tr>";
...
add_shortcode( 'industriales', 'twentysixteen_industriales_shortcode' );
